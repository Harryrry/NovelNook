...
export default {
    ...
    data() {
        return {
            ...
            tableData: [
              ...
              // {firstname: 'Tom',lastname: 'tim'},
              // {firstname: 'jacks',lastname: 'jons'},
              // {firstname: 'Alice',lastname: 'yoe'},
              // {firstname: 'Wood',lastname: 'moon'},
              // {firstname: 'Sun',lastname: 'day'},
              // {firstname: 'dz',lastname: 'jse'},
              // {firstname: 'Alice',lastname: 'yoe'},
              // {firstname: 'dz',lastname: 'jse'},
              // {firstname: 'Alice',lastname: 'yoe'},
              // {firstname: 'dz',lastname: 'jse'},
    ...
    methods: {
        ...
        //
        // },
      //换页面个数时，改变页面大小，重新排版整个页面
      handleSizeChange(val) {
        this.pageSize=val;
        // console.log(`每页 ${val} 条`);
      },
      //更换页面时，获取当前页面值，改变页面内容
